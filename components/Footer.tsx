...
export function Footer() {
  return (
    <div className="relative bg-black overflow-hidden" data-nav-theme="dark">
      {/* Background Image */}
      ...
      <div className="relative pt-64 pb-16">
        {/* Footer Container */}
        <div className="max-w-[1352px] mx-auto px-4 md:px-6 relative z-20">
          <footer className="bg-black/60 backdrop-blur-xl rounded-[2rem] px-8 md:px-16 lg:px-24 pt-16 md:pt-24 pb-8 border border-white/10">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 md:gap-12 mb-16">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 border-t border-zinc-800/50 space-y-4">
                  <p className="text-[10px] text-zinc-600 font-mono uppercase tracking-[0.5px]">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <p className="text-zinc-400 mb-2 font-mono text-xs uppercase tracking-[0.6px]">Victoria</p>
                  ...
                  <div>
                    <p className="text-zinc-400 mb-2 font-mono text-xs uppercase tracking-[0.6px]">Queensland</p>
                    <p className="text-sm text-zinc-500 leading-relaxed">
                      2/39 Ellison Rd<br />
                      Geebung QLD 4034
                    </p>
            ...
            <div className="pt-8 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-xs font-mono uppercase tracking-[0.6px]">
